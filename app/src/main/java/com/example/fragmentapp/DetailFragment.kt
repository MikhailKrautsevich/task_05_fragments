...
class DetailFragment : Fragment(R.layout.fragment_detail) {
    ...
    companion object {
        ...
        fun newDetailFragment(contactData: ContactData, pos: Int): DetailFragment {
        ...
        private fun createBundleWithContactData(contactData: ContactData): Bundle {
            val args = Bundle()
        ...
        fun getContactDataFromBundle(bundle: Bundle): ContactData {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bundle?.let {
            ...
            btnConfirm?.setOnClickListener {
                ...
                setFragmentResult(ListFragment.REQUEST_KEY, bundle1)
